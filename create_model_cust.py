...
from input_sequence_cust import SequenceFromPandas
...
class CreateModel:
	...
	def __init__(self, 
				 ...
				 multi_check=False, dense_neurons=1024, dense_layer=1, classes=2, y_col="label", 
				 load_model=None, fn_reader=None, fn_reader_val=None, add_nb=0, custom=False):
...
#         self.weight = [1.7293698, 0.70335622]
	...
	def set_train_generator(self, path_csv, path_train, path_csv2):
	...
	def set_val_generator(self, path_csv, path_val, path_csv2=None):
		df = pd.read_csv(path_csv)
		print(path_csv2)
		if path_csv2:
			df2 = pd.read_csv(path_csv2)
...
#       val_set = h5py.File("data/images_fullseq_20/images_fullseq_20_VAL.h5",'r')
#       images_val = test_set["images"]
#       labels_val = test_set["labels"]
#       antispoofing = AntiSpoofingMetric([images_val, labels_val], log_name='farfrr', period=1)
